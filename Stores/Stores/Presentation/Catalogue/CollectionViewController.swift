...
class CatalogueViewController: UIViewController {
    ...
    fileprivate let cataloguePresenter = CataloguePresenter()
    ...
    override func viewDidLoad() {
        ...
        cataloguePresenter.getProducts(category: "babyshoes")
    }
    @IBAction func babyBotton(_ sender: Any) {
        cataloguePresenter.getProducts(category: "babyshoes")
    }
    @IBAction func sportButton(_ sender: Any) {
        cataloguePresenter.getProducts(category: "classicshoes")
    }
    @IBAction func Classic(_ sender: Any) {
        cataloguePresenter.getProducts(category: "formalshoes")
    }
